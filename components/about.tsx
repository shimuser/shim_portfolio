...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"단국대학교","period":"2021.03-2026.02","description":"부동산학 전공 도시계획학 복수전공"},{"icon":"award","title":"단국대학교","period":"2021-2026","description":"Opic (IH)"},{"icon":"building","title":"창업","period":"2023~","description":"심HC"},{"icon":"user","title":"경험","period":"2022","description":"지역 당협 대학생위원장"},{"icon":"book","title":"어학연수","period":"2025","description":"토론토대학"},{"icon":"book","title":"학술동아리","period":"2022","description":"URID"},{"icon":"briefcase","title":"병원 사무보조","period":"2024~2025","description":"외국인 응대, 유선 업무, 데스크 접수,시설 관리, 운전, 물품 발주, 영수증 관리 및 엑셀 기록"},{"icon":"briefcase","title":"과천시청","period":"2026~","description":"사무보조"}],
    skills: [{"icon":"rocket","title":"실행력","description":"창업, 사업 운영 과정에서 물품 발주 및 선정 과정에서 커뮤니 케이션 및 이동 능력(25000km 무사고)\n위원장 활동 당시 추진했던 활동들"},{"icon":"code","title":"프로그램 및 기술 역량","description":"Auto CAD, Sketch UP, Rstudio, Framer(UIDX), After Effect, DJI mini 3pro(드론 조종)"},{"icon":"barChart","title":"데이터 분석","description":"Rstudio를 활용한 딥러닝, 지오매핑 등 분석기법 및 데이터 분석을 위한 자료 수집 및 필터링 방법"},{"icon":"users","title":"팀워크","description":"지역 당협 대학생위원장 활동 당시 추진 경험\n어학연수 앱디자인 프로젝트 진행 경험 및 교내 교환학생과 팀워크"},{"icon":"edit","title":"경험","description":"지역 당협, 지역 의정 경험을 통한 개발 과정에서의 프로세스 관련 경험\n창업 이후 수익화 및 유지 관리 경험"},{"icon":"target","title":"기획","description":"입지 및 부동산 임대 형식을 활용한 창업 전략 기획"}],
    storyTitle: "나의 이야기",
    story: ["저는 부동산학 및 도시계획학을 전공하며 부동산 PF, 사업전략 등를 비롯한 부동산 산업 에 대한 전반적인 이해도를 쌓았습니다.\n입사 후에는 학부에서 배운 지식을 통해 해당 업무에 빠르게 적응하고, 다양한 경험에서 배웠던 것들을 바탕으로 회사 업무 지원 및 보조에 도움이 되도록 하겠습니다. 또한, 회사에서 일하며 자기발전의 기회로 삼아 회사에서 꾸준하게 성장해 더 많은 기여를 할 수 있도록 하겠습니다.","저는 전공 지식과 다양한 실무 경험을 바탕으로 회사에 기여하고자 합니다. 먼저, 병원 데스크 및 장부 관련 업무 경험을 통해 소통 능력과 사무보조 업무 역량을 쌓았습니다. 병원 데스크 업무 과정에서 근무지 특성상 다양한 국적과 연령대의 환자들 접수를 보았고 여기서 비롯된 의사소통 문제를 극복했습니다. 이를 해결하기 위해서 자주 듣는 질문들을 카드뉴스 형식으로 미리 출력하여 질문 과정을 줄였고 여러 핵심 키워드를 중심으로 듣는 방법을 터득해 의사소통 문제를 해결했습니다. 또한, 사무보조 역량이 있습니다. 정산 업무나 탕비실 관리 업무, 공지 작성, 실제 기록과 장부에 차이가 있을 때 엑셀 수식에서 오류를 찾거나 기록된 지출 명세들을 대조해 가며 이러한 오류를 바로잡는 등등 실제로 숫자를 다루었습니다. 매일 청소하면서 확인할 수 있는 의료품목의 재고 체크리스트를 만들어 매일 확인하고 미리 발주할 수 있도록 해 시간에 쫒겨 주문하는 일이 없도록 하는 등 사무보조와 관련된 여러 경험을 하였습니다. 마지막으로, 환자가 없는 날에는 수술 날 이전에 미리 환자를 받을 수 있도록 정기 문자 수신업무를 보내는 등 능동적이고 유동적인 업무 해결을 했습니다.","또한, 건강기능식품 도/소매업 자영업을 직접 운영하여 사무직에 필요한 기본 역량을 쌓았으며 그 과정에서 자차를 소유 및 유지하고 있습니다. 직접 장부를 정리하고 재고를 관리하며 숫자를 정확하게 다루는 법을 익혔습니다. 최대한 엑셀 수식을 활용하여 업무량을 줄여 효율화 시켰습니다. 또한, 사업 운영의 전반적인 과정을 경험하며 자영업의 자금 흐름과 경영 방식에 대한 이해를 넓혔습니다."," 이 외에도 다양한 다른 경험 및 역량을 기반으로 업무에 도움이 되고자 합니다.\n"],
    storyImage: "/uploads/about-image-1765091544968.png",
